...
class chongqing_2Spider(scrapy.Spider):
    ...
    start_urls = [
        ('https://www.cqggzy.com/web/services/PortalsWebservice/getInfoList?response=application/json'
    ...
    def parse_item(self, response):
        ...
        body = response.css('#mainContent') or response.css('div.epoint-article-content')
